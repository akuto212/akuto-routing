# Добавление роутинга `AkutoRouting` в Marzneshin для пользователей обычных подписок (не JSON)
...
- Готово! Теперь в Happ вместе с подписками поставляется всегда свежий роутинг `AkutoRouting`
